...
const es = {
  settings: {
    ...
    pairSmartwatch: 'Vincular Smartwatch',
    pairSmartwatchDesc: 'Iniciar sesión en el reloj',
    smartwatchTitle: 'Vincular Smartwatch',
    smartwatchDesc: 'Genera un código único de 6 dígitos que cambia cada minuto para iniciar sesión desde tu reloj de forma ultra segura.',
    generateCode: 'Generar código',
    codeExpires: 'Este código expira en',
    minutes: 'minutos',
...
const en: typeof es = {
  settings: {
    ...
    pairSmartwatchDesc: 'Log in on the watch',
    smartwatchTitle: 'Pair Smartwatch',
    smartwatchDesc: 'Generate a unique 6-digit code that changes every minute to log in from your watch ultra securely.',
    generateCode: 'Generate code',
    codeExpires: 'This code expires in',
    minutes: 'minutes',
